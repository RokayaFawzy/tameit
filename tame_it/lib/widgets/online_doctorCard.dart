...
class onlineDoctorCard extends StatefulWidget {
  final Doctor doctor;

  onlineDoctorCard({super.key, required this.doctor});

  @override
  State<onlineDoctorCard> createState() => _onlineDoctorCardState();
}

class _onlineDoctorCardState extends State<onlineDoctorCard> {
